...
from detector.utils.general import xywh2xyxy, xyxy2xywh
from detector.utils.metrics import fitness
...
def plot_one_box(x, img, color=None, label=None, line_thickness=3, label_down=False):
