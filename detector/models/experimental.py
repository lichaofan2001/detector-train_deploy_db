...
from detector.models.common import Conv, DWConv
...
def attempt_load(weights, map_location=None):
    ...
    # Uses torch_load wrapper for backward-compatible module path resolution
    model = Ensemble()
    for w in weights if isinstance(weights, list) else [weights]:
        attempt_download(w)
        ckpt = torch_load(w, map_location=map_location)  # load with module path remapping
